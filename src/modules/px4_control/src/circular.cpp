...
Eigen::Vector3d temp_pos_drone; // the origin position when offboard
Eigen::Vector3d temp_pos_target; // the fist position on the circle
		...
		case FLY:
			{
				...
				send_pos_setpoint(pos_target, Omega);
